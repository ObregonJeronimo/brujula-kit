...
export default function NewELDI({onS,nfy}){
  ...
  useEffect(()=>{
    if(!dirty)return;
    const handler=e=>{e.preventDefault();e.returnValue="¿Está seguro que desea salir? Los cambios NO se guardarán.";};
