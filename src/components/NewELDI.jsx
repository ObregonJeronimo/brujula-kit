...
export default function NewELDI({onS,nfy}){
  ...
  const NOTA_TEXT = "Nota: La clasificaci\u00f3n se basa en un an\u00e1lisis criterial (comparaci\u00f3n con hitos esperados por edad), no en baremos normativos. Cortes: \u226590% = Normal, 75-89% = En Riesgo, 50-74% = Retraso Moderado, menos de 50% = Retraso Significativo.";
