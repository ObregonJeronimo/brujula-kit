  ...
  try {
    ...
    if (reportMode === "cud") {
      ...
      userPrompt = "Con estos datos de una evaluacion fonoaudiologica, redacta un INFORME FONOAUDIOLOGICO BREVE Y CLINICO.\n\n"
        ...
        + "Luego estas secciones breves:\n"
        + "DIFICULTADES OBSERVADAS: (describir aspectos comprometidos)\n"
        + "CATEGORIAS O AREAS COMPROMETIDAS: (tipos de sonidos o areas afectadas)\n"
        + "FONEMAS O ASPECTOS ALTERADOS: (listar fonemas alterados o areas con dificultad)\n"
        + "OBSERVACION CLINICA: (patrones observados durante la evaluacion)\n"
        + "CONCLUSION: (resumen clinico breve y recomendacion de intervencion)\n\n"
        + "Maximo 15-20 lineas. Sin porcentajes ni tablas.\n"
        + "Redactalo como un fonoaudiologo en un informe clinico breve.\n\n"
        + summary.header + "\n" + summary.data + "\nOBS: " + summary.obs;
    }
